...
- Documenter et appliquer des pratiques de développement durable (respecter les ODDs 8,9,10,12 et 17)
## Tech Stack
### Frontend
- HTML5
- CSS3
...
### Controller
Gère la logique métier et la communication entre le Model et la View en PHP : réception et validation des requêtes, orchestration des actions 
### Workflow
1. L’utilisateur interagit avec l’interface.
2. Une requête est envoyée au Controller.
3. Le Controller traite la logique métier
4. Le Model accède à la base de données pour lire ou écrire les données.
5. Une réponse est renvoyée à l’utilisateur via la View
## Contributors
